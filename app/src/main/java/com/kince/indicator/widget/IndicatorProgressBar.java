...
package com.kince.indicator.widget;
...
public class IndicatorProgressBar extends ProgressBar {
	...
	public IndicatorProgressBar(Context context, AttributeSet attrs, int defStyle) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.IndicatorProgressBar, defStyle, 0);

		if (a != null) {
			m_textPaint.setTextSize(a.getDimension(R.styleable.IndicatorProgressBar_textSize, 10));
			m_textPaint.setColor(a.getColor(R.styleable.IndicatorProgressBar_textColor, Color.WHITE));

			int alignIndex = (a.getInt(R.styleable.IndicatorProgressBar_textAlign, 1));
			if (alignIndex == 0) {
			...
			int textStyle = (a.getInt(R.styleable.IndicatorProgressBar_textStyle, 1));
			if (textStyle == 0) {
			...
			m_indicator = a.getDrawable(R.styleable.IndicatorProgressBar_progressIndicator);

			m_offset = (int) a.getDimension(R.styleable.IndicatorProgressBar_offset, 0);

			Drawable indicator = a.getDrawable(R.styleable.IndicatorProgressBar_indicator);
